...
describe("Persona Client Test Suite", function(){
    ...
    describe("- Validate Token tests", function(){
        ...
        it("should not validate an invalid token - Persona route version 1", function(done){
            var personaClient = persona.createClient({
                persona_host:"persona",
                persona_port:80,
                persona_scheme:"http",
        ...
        it("should not validate an invalid token - Persona route version 2", function(done){
            var personaClient = persona.createClient({
                persona_host:"persona",
                persona_port:80,
                persona_scheme:"http",
        ...
        it("should not validate an invalid scoped token - Persona route version 1", function(done){
            // use _getOAuthToken to generate a token outside of the node client
            _getOAuthToken("primate", function(err, token){
                var personaClient = persona.createClient({
                    persona_host:"persona",
        ...
        it("should not validate an invalid scoped token - Persona route version 2", function(done){
            // use _getOAuthToken to generate a token outside of the node client
            _getOAuthToken("primate", function(err, token){
                var personaClient = persona.createClient({
                    persona_host:"persona",
